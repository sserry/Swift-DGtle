...
class SDGSettingViewController: SDGBaseViewController {
    ...
    var settingTable: UITableView = {
        ...
        table.register(UINib(nibName: "SDGShareIconCell", bundle: nil), forCellReuseIdentifier: SDGShareIconCell.cellReuseIdentifier)
        return table
    }()
...
extension SDGSettingViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 2 && indexPath.row == 1 {
            return SDGShareIconCell.configureCellForTableView(tableView, aModelSource: "")
        } else {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        return indexPath.section == 2 && indexPath.row == 1  ? SDGShareIconCell.height : SDGSettingTableViewCell.cellHeight
    }
